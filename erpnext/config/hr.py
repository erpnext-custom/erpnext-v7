...
def get_data():
    return [
        ...
        {
            "label": _("Dispatch & Notesheet"),
            "icon": "icon-cog",
            "items": [
                {
                    "type": "doctype",
                    "name": "Dispatch",
                    "description": _("dispatch for HR Module")
                },
                {
                    "type": "doctype",
                    "name": "Notesheet",
                    "description": _("Notesheet for HR Module")
                },
                {
                    "type": "report",
                    "is_query_report": True,
                    ...
                    "Doctype": "Dispatch",
                    "description": _("dispatch report for HR Module")
                },	  	                           
            ]
        },
        {
            ...
            "items": [
                {
                    "type": "doctype",
                    "name": "PMS",
                    "description": _("Performance Management System")
                },
                {
                    "type": "doctype",
                    "name": "PMS Evaluation",
                    "description": _("Performance Management System Evaluation")
                },
                {
                    "type": "doctype",
                    "name": "Output",
                    "description": _("Output")
                }
            ]
        }
    ]
