...
frappe.ui.form.on('Vehicle Request', {
	refresh: function(frm) {
		cur_frm.toggle_reqd("rejection_message", frm.workflow_state == 'Rejected by Supervisor');
		cur_frm.toggle_reqd("rejection_message", frm.workflow_state == 'Rejected By MTO');
