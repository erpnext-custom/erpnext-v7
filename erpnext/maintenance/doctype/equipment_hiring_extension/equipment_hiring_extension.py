...
class EquipmentHiringExtension(Document):
	...
	def check_hire_rate(self, doc):
                ...
                if doc.rate_type == "Cft - Broadleaf":
                        self.rate = data[0].cft_rate_bf
                if doc.rate_type == "Cft - Conifer":
                        self.rate = data[0].cft_rate_co
