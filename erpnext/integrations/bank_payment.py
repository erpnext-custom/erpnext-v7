...
from erpnext.integrations import SftpClient
...
class BankPayment(Document):
	...
	def validate_mandatory(self):
		...
		elif not flt(self.bank_balace) or (flt(self.total_amount) > flt(self.bank_balance)):
	...
	def load_items(self):
		...
		if not self.get("items"):
			...
			return total_amount
		# self.set_payment_type()	# TEMPORARILY DISABLED
