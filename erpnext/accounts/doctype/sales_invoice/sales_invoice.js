...
erpnext.accounts.SalesInvoiceController = erpnext.selling.SellingController.extend({
	...
	"discount_or_cost_amount": function(frm) {
		cur_frm.set_value("discount_amount", flt(this.frm.doc.discount_or_cost_amount) - flt(this.frm.doc.transportation_charges) - flt(this.frm.doc.additional_cost) - flt(this.frm.doc.loading_cost))
