...
def validate_expense_against_budget(args):
	...
	action = frappe.db.sql("select action_if_annual_budget_exceeded as action from tabBudget where cost_center=%s and fiscal_year = %s and docstatus = 1", (args.cost_center, args.fiscal_year))
