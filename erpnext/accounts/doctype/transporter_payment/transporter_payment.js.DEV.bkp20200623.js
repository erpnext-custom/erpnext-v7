...
var total_html = function(frm){
	...
	row += '<tr><td>Transfer Charges</td><td align="right">'+numberWithCommas(roundToTwo(parseFloat(frm.doc.transfer_charges?frm.doc.transfer_charges:0)))+'</td><td style="padding: 5px;">(+)</td></tr>';
	row += '<tr><td>Delivery Charges</td><td align="right">'+numberWithCommas(roundToTwo(parseFloat(frm.doc.delivery_charges?frm.doc.delivery_charges:0)))+'</td><td style="padding: 5px;">(+)</td></tr>';
