...
frappe.ui.form.on('Opening Invoice Creation Tool', {
	setup: function(frm) {
		...
		// Following code added by SHIV on 2018/10/24
		frm.get_docfield("invoices").allow_bulk_edit = 1;		
		frm.get_field('invoices').grid.editable_fields = [
			{fieldname: 'party', columns: 2},
			{fieldname: 'cost_center', columns: 2},
			{fieldname: 'posting_date', columns: 1},
			{fieldname: 'due_date', columns: 1},
