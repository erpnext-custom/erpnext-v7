...
def execute(filters=None):
	...
	exclude = [str("Bank & Cash - DS"), str("Inventories - DS"), str("Stock Assets - DS"), str("Tax - DS"), str("Temporary Accounts - DS"), str("Trade Receivables - DS"), str("Other Expenses - DS"), str("Stock Expenses - DS"), str("Accumulated Depreciation - DS"), str("Receipts - DS")]
