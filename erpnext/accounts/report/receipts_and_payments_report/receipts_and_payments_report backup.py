...
def get_data(filters):
	accounts = frappe.db.sql("""select name,  parent_account, account_name, root_type, report_type, lft, rgt
		from `tabAccount` where company=%s and name not in ("Temporary Account - DS", "Trade Receivable - DS","Stock Asset - DS","Trade Payables - DS","Other Receipts - DS","Other Expenses - DS","Accumulated Depreciation - DS") order by name ASC""", filters.company, as_dict=True)
