...
def get_columns(filters):
	...
	if filters.purpose == "Material Transfer":
                ...
                cols.append(("Source Warehouse")+":Link/Warehouse:170")
                cols.append(("Receiving Warehouse")+":Link/Warehouse:170")
                cols.append(("Stock Entry")+":Link/Stock Entry:170")

	if filters.purpose == "Material Issue":
		cols.append(("Cost Center")+":data:170")
		cols.append(("Warehouse")+":Link/Warehouse:170")
		cols.append(("Stock Entry")+":Link/Stock Entry:170")
		cols.append(("Issue To")+":data:170")
