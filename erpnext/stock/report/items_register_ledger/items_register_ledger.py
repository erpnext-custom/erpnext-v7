...
def get_columns(filters):
        cols =  [
                ...
                ("Posting Date") + ":Date:120", ("Issued To")+ ":Link/Employee:100", ("Employee Name") + ":Data:120", ("Quantity") + ":Data:70",
                ("Ref Document")+ ":Link/Stock Entry:150"
        ]
        cols1 = [
                ("Material Code") + ":Link/Item:120", ("Material Name") + ":Data:120",
                ("Issued To")+ ":Link/Employee:100", ("Employee Name") + ":Data:120", ("Quantity") + ":Data:70"
        ]
