...
def enqueue_replace_bom(args):
	...
	enqueue("erpnext.manufacturing.doctype.bom_update_tool.bom_update_tool.replace_bom", args=args, timeout=4000)
	frappe.msgprint(_("Queued for replacing the BOM. It may take a few minutes."))

@frappe.whitelist()
def enqueue_update_cost():
	
	#enqueue("erpnext.manufacturing.doctype.bom_update_tool.bom_update_tool.update_cost")
	enqueue("erpnext.manufacturing.doctype.bom_update_tool.bom_update_tool.update_cost")
