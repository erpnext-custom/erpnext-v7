...
# Shiv 2019/01/21 following line uncommented as the SMCL gets the settings from Leave Encashment Settings
		...
		for a in self.items:
			if flt(a.difference) == 0:
				pass
                                ...
                                # Shiv 2019/01/21 following line commnted as the SMCL gets the settings from Leave Encashment Settings
