...
def add_header(w):
	...
	w.writerow(["Employee", "Employee Name", "Basic", "Corporate", "HRA",  "Contract", "Communication", "Fuel", "Temporary Transfer Allowance", 
	...
	for i, row in enumerate(rows[3:]):
		...
		try:
			...
			if d.employee:
				...
				if d.hra:
                                        if emp.employment_type == 'Deputation':
				...
				if d.communication:
					...
					doc.communication_allowance = flt(d.communication)
				...
				if d.fuel:
					...
					doc.fuel_allowances = flt(d.fuel)
					#amount = flt(d.fuel)
