...
class SalaryAdvance(Document):
	...
	def on_submit(self):
        ...
        def validate_amounts(self):
                if flt(self.total_claim) > flt(self.basic_pay) * 2:
                        frappe.throw(_("Advance requested cannot be more than maximum limit <b>Nu. {0}/-</b>").format("{:,.2f}".format(2* self.basic_pay)), title="Invalid Data")
