...
def get_data(filters):
	...
	(select ee.qualification from `tabEmployee Education` ee where ee.parent = e.name and ee.is_highest_qualification_level = 1) as course,
	(select ee.level from `tabEmployee Education` ee where ee.parent = e.name and ee.is_highest_qualification_level = 1) as qualification,
	(select ee.school_univ from `tabEmployee Education` ee where ee.parent = e.name and ee.is_highest_qualification_level = 1) as school_univ,
	(select ee.country from `tabEmployee Education` ee where ee.parent = e.name and ee.is_highest_qualification_level = 1) as country,
