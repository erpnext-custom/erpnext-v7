...
class Budget(Document):
	...
	def get_accounts(self):
		query = "select name as account, account_code from tabAccount where account_type in (\'Expense Account\',\'Fixed Asset\',\'Capital Work in Progress\') and is_group = 0 and company = \'" + str(self.company) + "\' and (freeze_account is null or freeze_account != 'Yes') order by account_code ASC"
