...
def get_data(filters):
	...
	for d in query:
		...
		prd = frappe.db.sql("""
			...
			pr.destination_dzongkha, pr.end_date, pr.is_new_customer, pr.location, pr.no_of_story, pr.others, pri.qty,
