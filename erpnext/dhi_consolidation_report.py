...
from erpnext.accounts.report.consolidation_report.consolidation_report import get_data, create_transaction

@frappe.whitelist(allow_guest=True)
def dhi_consolidation_report(from_date=None,to_date=None):
    filters = {}
