...
def get_data(query, filters=None):
	...
	for d in datas:
		row = [d.branch, d.entry_date, d.item_code, d.item_name, d.serial_number, d.equipment_type, d.equipment_model, d.reg_number, d.brand, d.engine_no,
			d.chesis_no, d.qty, d.custodian, d.issued_date, d.amount]
		data.append(row);
	return data

def construct_query(filters=None):
	query = """select id.branch, id.serial_number, id.entry_date, id.item_code, id.item_name, id.qty,id.serial_number, 
