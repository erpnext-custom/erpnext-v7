frappe.listview_settings['Project'] = {
	...
	get_indicator: function(doc) {
		if(parseFloat(doc.tot_wq_percent_complete || 0.0) < parseFloat(doc.tot_wq_percent || 0.0)){
			return [__("{0}% Complete", [Math.round(doc.tot_wq_percent_complete)]), "orange", "tot_wq_percent_complete,>=,0|status,=,Ongoing"];
		} else if(parseFloat(doc.tot_wq_percent_complete || 0.0) >= parseFloat(doc.tot_wq_percent || 0.0)){
