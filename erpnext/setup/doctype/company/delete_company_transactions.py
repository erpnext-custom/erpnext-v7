...
def delete_company_transactions(company_name):
	...
	'''
        ...
        dt_list = frappe.db.sql_list("""
                        select name
                        from `tabDocType`
                        where module in ('Assets','Budget','Accounts','Buying','CRM','HR','Maintenance','Manufacturing','Projects','Schools','Selling','Stock')
